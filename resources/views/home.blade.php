...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('foodmart/css/normalize.css') }}">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="{{ asset('foodmart/css/vendor.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('foodmart/css/style.css') }}">
  ...
  <body>
    ...
    <header>
      <div class="container-fluid">
        <div class="row py-3 border-bottom align-items-center">
          ...
          <!-- Logo di kiri -->
          <div class="col-3 col-lg-3 text-start">
            <div class="main-logo">
              <a href="index.html">
                <img src="{{ asset('foodmart/images/logo.png') }}" alt="logo" class="img-fluid" style="max-height: 50px;">
              </a>
            </div>
          </div>

          <!-- Wrapper tengah dan kanan (flex container) -->
          <div class="col-9 col-lg-9 d-flex align-items-center justify-content-between">
            ...
            <div class="cart text-end d-none d-lg-block dropdown ms-3">
              <button class="border-0 bg-transparent d-flex flex-column gap-1 lh-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart" style="min-width: 140px;">
                ...
                <div class="offcanvas-body">
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    <li class="nav-item active">
                      <a href="#cake" class="nav-link">Cake</a>
                    </li>
                    <li class="nav-item dropdown">
                      <a href="#chocolate" class="nav-link">Chocolate</a>
                    </li>
                    <li class="nav-item">
                      <a href="#candy" class="nav-link">Candy</a>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <h3 class="display-4">The New Donuts With Red White Blue Sprinkles</h3>
                          <p>Grab it fast</p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">Shop Now</a>
                        </div>
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset('foodmart/images/1.png') }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset('foodmart/images/5.png') }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset('foodmart/images/11.png') }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('foodmart/images/product-thumb-11.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('foodmart/images/product-thumb-12.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('foodmart/images/product-thumb-13.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('foodmart/images/product-thumb-14.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
      ...
      <div class="container">
            ...
            <div class="col-md-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-5">
                    ...
                    <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        ...
                        <div class="product-item">
                            ...
                            <figure>
                            <a href="index.html" title="Product Title">
                                <img src="{{ asset('foodmart/images/thumb-orange-juice.png') }}"  class="tab-image">
                            </a>
                            </figure>
                            <h3>Sunstar Fresh Melon Juice</h3>
                            <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                        ...
                        <div class="product-item">
                            ...
                            <figure>
                            <a href="index.html" title="Product Title">
                                <img src="{{ asset('foodmart/images/thumb-raspberries.png') }}"  class="tab-image">
                            </a>
                            </figure>
                            <h3>Sunstar Fresh Melon Juice</h3>
                            <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                        ...
                        <div class="product-item">
                            ...
                            <figure>
                            <a href="index.html" title="Product Title">
                                <img src="{{ asset('foodmart/images/thumb-tomatoes.png') }}"  class="tab-image">
                            </a>
                            </figure>
                            <h3>Sunstar Fresh Melon Juice</h3>
                            <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                        ...
                        <div class="product-item">
                            ...
                            <figure>
                            <a href="index.html" title="Product Title">
                                <img src="{{ asset('foodmart/images/thumb-tomatoketchup.png') }}"  class="tab-image">
                            </a>
                            </figure>
                            <h3>Sunstar Fresh Melon Juice</h3>
                            <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
    ...
    <section class="py-5">
      <div class="container-fluid">
        ...
        <div class="bg-secondary py-5 my-5 rounded-5" style="background: url('{{ asset('foodmart/images/bg-leaves-img-pattern.png') }}') no-repeat;">
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{ asset('foodmart/images/post-thumb-1.jpg') }}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{ asset('foodmart/images/post-thumb-2.jpg') }}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{ asset('foodmart/images/post-thumb-3.jpg') }}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
      ...
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <img src="{{ asset('foodmart/images/phone.png') }}" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  <img src="{{ asset('foodmart/images/app-store.jpg') }}" alt="app-store">
                  <img src="{{ asset('foodmart/images/google-play.jpg') }}" alt="google-play">
                </div>
              </div>
            </div>
          </div>
